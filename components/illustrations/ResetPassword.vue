<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
    ...
    <g id="freepik--speech-bubble--inject-44">
      <polygon
        points="127.37 139.57 130.69 150.24 134 139.57 127.37 139.57"
        style="fill: #0ea5e9"
      ></polygon>
      <rect
        x="94.95"
    ...
    <g id="freepik--Character--inject-44">
      <path
        d="M174.07,214.07l6.1-3.95-6.87-4.22s-5.23,3.85-3.13,6.46Z"
        style="fill: #b55b52"
      ></path>
      <polygon
      ...
      ></path>
      <path
        d="M143,167.56c.75,2.77,0,8.39-3.72,6.39S141.75,162.78,143,167.56Z"
        style="fill: #263238"
      ></path>
      <path
      ...
      <path
        d="M132,313.57l-4.26-23.19.82-12.27S134.39,299.39,132,313.57Z"
        style="opacity: 0.2"
      ></path>
      <path
      ...
      <g style="opacity: 0.2">
        <path
          d="M103,261.32l2,1.87A10.2,10.2,0,0,0,91,278l-2-1.88a10.19,10.19,0,0,1,14-14.83Z"
        ></path>
        <path
          d="M116.49,260l2,1.88a20.48,20.48,0,0,1-28.1,29.79l-2-1.87a20.48,20.48,0,0,0,28.1-29.8Z"
        ></path>
      </g>
      <g style="opacity: 0.2">
        <path
