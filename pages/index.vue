        ...
        <section class="flex flex-col-reverse md:flex-row items-center justify-between mb-20">
            <div class="w-full md:basis-1/2 lg:basis-1/3 md:mr-5 lg:mr-0">
                ...
                <p class="mb-7 md:mb-10">
                    <strong class="text-primary">Судимости<span class="text-dark">.нет</span></strong> - это платформа с
                    помощью которой вы можете получить справку об отсутвии судимости. Просто оставьте заявку заполнив
                    форму своими данными!
                </p>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="w-full md:basis-1/2 lg:basis-1/3">
                    ...
                    <p class="mb-3 md:mb-5">
                        <strong>Справка об отсутствии <i>(наличии)</i> судимости</strong> — докумен <i>(справка)</i>,
                        который подтверждает отсутствие <i>(наличие)</i> судимости гражданина. Данный документ может
                        потребоваться:
                    </p>
                    <ul>
                        <li
